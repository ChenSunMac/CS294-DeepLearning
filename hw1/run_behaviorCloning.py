"""
Created on Mon Oct  1 17:06:28 2018



Behavorial cloning of an expert policy using a simple Feedforward Neural Network.
Example usage:
    python run_behaviorCloning.py experts/Humanoid-v2.pkl Humanoid-v2 expert_data/Humanoid-v2.pkl \
    ...
    with tf.Session():
        ...
        for i in range(args.num_rollouts):
            ...
            while not done:
                ...
                obs = obs.reshape(1, len(obs)) # obs = obs.reshape(1, len(obs), 1)
